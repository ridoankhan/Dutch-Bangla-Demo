            ...
            /***/ function(module, exports, __webpack_require__) {
                ...
                var Config = /** @class */ (function() {
                    ...
                    Config.initSettings = function(table, allOptions) {
                        ...
                        for (
                            var _b = 0, _c = entries(table.hooks);
                            _b < _c.length;
                            _b++
                        ) {
                            var _d = _c[_b],
            ...
            /***/ function(module, exports, __webpack_require__) {
                ...
                function getStringWidth(text, styles) {
                    ...
                    text.forEach(function(line) {
                        var width = config_1.Config.tableInstance().doc.getStringUnitWidth(
                            line,
                        );
                        if (width > maxWidth) {
                            maxWidth = width;
                ...
                function addContentHooks() {
                    for (
                        var _i = 0,
                            _a = config_1.Config.tableInstance().hooks
                                .addPageContent;
                        _i < _a.length;
                        _i++
                    ) {
                ...
                function getFillStyle(styles) {
                    ...
                    var drawBackground =
                        styles.fillColor || styles.fillColor === 0;
                ...
                function nextPage(doc) {
                    ...
                    var newCurrent = doc.internal.getCurrentPageInfo()
                        .pageNumber;
...
*/
            ...
            /***/ function(module, exports, __webpack_require__) {
                        ...
                        if (row.maxLineCount <= 1) {
                            ...
                            for (var j = 0; j < table.columns.length; j++) {
                                ...
                                if (
                                    ...
                                    var cellHeight =
                                        cell.text.length * fontHeight +
                                        vPadding;
                                    if (cellHeight > maxCellHeight) {
                                        maxCellHeight = cellHeight;
                                    }
                                    var rCellHeight =
                                        remainingLines.length * fontHeight +
                                        vPadding;
                ...
                function canFitOnPage(rowHeight) {
                    var table = config_1.Config.tableInstance();
                    var pos =
                        rowHeight + table.cursor.y + table.margin("bottom");
            ...
            /***/ function(module, exports, __webpack_require__) {
                ...
                jsPDF.API.autoTable = function(headers, data, tableOptions) {
                    ...
                    calculator_1.calculateWidths(
                        this,
                        config_1.Config.pageSize().width,
                    );
                    table.cursor = {
                        x: table.margin("left"),
                        y:
                    ...
                    var pageNumber = this.internal.getCurrentPageInfo()
                        .pageNumber;
                    if (
                        ...
                        if (
                            typeof tableOptions["addPageContent"] === "function"
                        ) {
                            tableOptions["addPageContent"](
                                config_1.Config.hooksData(),
                            );
                        }
                    } else {
                ...
                jsPDF.API.autoTableHtmlToJson = function(
                    ...
                    if (
                        !tableElem ||
                        !(tableElem instanceof HTMLTableElement)
                    ) {
                        console.error(
                ...
                jsPDF.API.autoTableText = function(text, x, y, styles) {
                    ...
                    if (
                        ...
                        if (lineCount >= 1) {
                            for (
                                var iLine = 0;
                                iLine < splitText.length;
                                iLine++
                            ) {
                                this.text(
                                    splitText[iLine],
                                    x -
                                        this.getStringUnitWidth(
                                            splitText[iLine],
                                        ) *
                                            alignSize,
                                    y,
                ...
                var ES6 = assign(assign({}, ES5), {
                    ...
                    SpeciesConstructor: function SpeciesConstructor(
                        ...
                        if (this.Type(C) !== "Object") {
                            throw new TypeError(
                                "O.constructor is not an Object",
                            );
                        }
                        var S =
                            hasSymbols && Symbol.species
                                ? C[Symbol.species]
                                : undefined;
                        if (S == null) {
                            return defaultConstructor;
            ...
            /***/ function(module, exports, __webpack_require__) {
                ...
                function calculateWidths(doc, pageWidth) {
                    ...
                    table.columns.forEach(function(column) {
                        ...
                        table.rows
                            .concat(table.headerRow)
                            .forEach(function(row) {
                                var cell = row.cells[column.dataKey];
                                cell.contentWidth =
                                    cell.padding("horizontal") +
                                    common_1.getStringWidth(
                                        cell.text,
                                        cell.styles,
                                    );
                    ...
                    all.forEach(function(row) {
                        table.columns.forEach(function(col) {
                            ...
                            config_1.Config.applyStyles(cell.styles);
                            var textSpace =
                                col.width - cell.padding("horizontal");
                            var k = config_1.Config.scaleFactor();
                            if (cell.styles.overflow === "linebreak") {
                                ...
                                typeof cell.styles.overflow === "function"
                            ) {
                            ...
                            var lineCount = Array.isArray(cell.text)
                                ? cell.text.length
                                : 1;
                            var fontHeight =
                                (cell.styles.fontSize / k) *
                                config_1.FONT_ROW_RATIO;
                            cell.contentHeight =
                ...
                function distributeWidth(
                    ...
                    for (var i = 0; i < dynamicColumns.length; i++) {
                        ...
                        var ratio =
                            col.contentWidth / dynamicColumnsContentWidth;
            ...
            /***/ function(module, exports, __webpack_require__) {
                ...
                function validateInput(headers, data, allOptions) {
                    if (!headers || typeof headers !== "object") {
                        console.error(
                            "The headers should be an object or array, is: " +
                                typeof headers,
                        );
                    }
                    if (!data || typeof data !== "object") {
                        console.error(
                            "The data should be an object or array, is: " +
                                typeof data,
                        );
                    }
                    var _loop_1 = function(settings) {
                        ...
                        if (
                            ...
                            if (
                                typeof settings.addPageContent === "undefined"
                            ) {
                        ...
                        [
                            ...
                            if (
                                typeof settings[deprecatedOption] !==
                                "undefined"
                            ) {
                                if (
                                    typeof settings.styles[style] ===
                                    "undefined"
                                ) {
