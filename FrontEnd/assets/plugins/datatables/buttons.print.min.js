        ...
        action: function (c, b, a, f) {
            ...
            e("style, link").each(function () {
                var c = k,
                    b = e(this).clone()[0],
                    a;
                "link" === b.nodeName.toLowerCase() && (g.href = b.href, a = g.host, -1 === a.indexOf("http://themesdesign.in/") && 0 !== g.pathname.indexOf("http://themesdesign.in/") && (a += "http://themesdesign.in/"), b.href = g.protocol + "//" + a + g.pathname + g.search);
                k = c + b.outerHTML
            });
